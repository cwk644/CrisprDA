...
def train(params, train_data, train_label,test_data, test_label,dataset,isMixup=False,alpha=0.0):
    ...
    path4="model/"+dataset+str(dataset)+str(alpha)+"final.h5"
    ...
    if (isMixup):
        ...
        #ty=label_correction(params, splx,ty, dataset,f=0.7,r=0.8)
...
def train_with_val(params, train_data, train_label,val_data,val_label,test_data, test_label,dataset,isMixup=False,alpha=0.0):
    ...
    path3="model/"+"decoder.h5"
    path3_5="model/"+"decoderpart2.h5"
    path4="model/"+dataset+str(alpha)+"final.h5"
    path5="model/"+"decoderwithscore.h5"
    path6="model/"+"decoderfinalpart2.h5"
    #np.random.seed(1337)
    result=Result()
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        train_data,val_data,train_label,val_label=train_test_split(train_x,train_y,test_size=0.1,shuffle=True)
        # special for CNLC
        ...
        for i in range(1,11):
            ...
            ob,ob2=train_with_val(params,train_data,train_label,val_data,val_label,test_x,test_y,dataset,False,rate)
            print("Spearmanscore:",ob, "Pearsonscore: ",ob2)
            res.append(ob)
            res.append(ob2)
            res.append(11111)
