...
def save_split(train_x,train_y,val_x,val_y,test_x,test_y,dataset):
    np.save("train/"+dataset+"_train_x.npy",train_x)
    np.save("train/"+dataset+"_train_y.npy",train_y)
    np.save("test/"+dataset+"_test_x.npy",test_x)
    np.save("test/"+dataset+"_test_y.npy",test_y)
    np.save("val/"+dataset+"_val_y.npy",val_y)
    np.save("val/"+dataset+"_val_x.npy",val_x)
    
def load_data(dataset):
    train_x=np.load("train/"+dataset+"_train_x.npy")
    train_y=np.load("train/"+dataset+"_train_y.npy")
    test_x=np.load("test/"+dataset+"_test_x.npy")
    test_y=np.load("test/"+dataset+"_test_y.npy")
    val_x=np.load("val/"+dataset+"_val_x.npy")
    val_y=np.load("val/"+dataset+"_val_y.npy")
    return train_x,test_x,val_x,val_y,train_y,test_y
